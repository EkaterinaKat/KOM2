...
public class KomDaoImpl implements KomDao {
    ...
    public void saveNew(RegularTask regularTask) {
        ...
        for (Date date : regularTask.getDates()) {
            RtDate rtDate = new RtDate();
            rtDate.setRegularTaskId(regularTaskDao.getLastInsertedId());
            rtDate.setValue(date);
            rtDateDao.saveNew(rtDate);
        }
    }
    ...
    public void update(RegularTask regularTask) {
        ...
        for (Date date : regularTask.getDates()) {
            RtDate rtDate = new RtDate();
            rtDate.setRegularTaskId(regularTask.getId());
            rtDate.setValue(date);
            rtDateDao.saveNew(rtDate);
        }
